...
if __name__ == "__main__":
	...
	path_to_browsermobproxy = r"C:\Users\todupva\Documents\TestingAutomation\browsermob-proxy-2.1.4-bin\browsermob-proxy-2.1.4\bin"

	# Start the server with the path and port 8090
	server = Server(r'C:\Users\todupva\Documents\TestingAutomation\browsermob-proxy-2.1.4-bin\browsermob-proxy-2.1.4\bin\browsermob-proxy', options={'port': 8090})
	server.start()
